...
urlpatterns = [
    ...
    path('ingredient_search/meal_type=<str:meal_type>&date=<date>', ingredient_search_by_code, name='ingredient_search'),
    path('add_ingredient/meal_type=<str:meal_type>&date=<date>&code=<code>', add_ingredient_in_diary, name='add_ingredient'),
